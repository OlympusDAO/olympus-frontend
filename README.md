...
This is the front-end repo for Tokenrace that allows users be part of the future of racing tokens.
...
```bash
$ git clone https://github.com/tokenrace/tokenrace-frontend.git
$ cd tokenrace-frontend
...
| Branch | URL |
| --- | --- |
| master | https://app.tokenracedao.finance |
| deploy | https://staging.tokenracedao.finance |
...
We keep an updated list of bugs/feature requests in [Github Issues](https://github.com/tokenrace/tokenrace-frontend/issues).
