...
export const TENDER_ADDRESSES: any = {
  [NetworkId.MAINNET]: "",
  [NetworkId.FANTOM]: "0x5602df4a94eb6c680190accfa2a475621e0ddbdc",
  [NetworkId.FANTOM_TESTNET]: "0x313987763809Fa69E02744aaA817A4A6909CBd73",
};

export const STAKED_TENDER_ADDRESSES: any = {
  [NetworkId.MAINNET]: "",
  [NetworkId.FANTOM]: "0x8e2549225E21B1Da105563D419d5689b80343E01",
  [NetworkId.FANTOM_TESTNET]: "0x5ee644AE1aA7D8DA5697A1435a8CEC5a110875A8",
};
export const WRAPPED_TENDER_ADDRESSES: any = {
  [NetworkId.MAINNET]: "",
  [NetworkId.FANTOM]: "0x89346b51a54263cf2e92da79b1863759efa68692",
  [NetworkId.FANTOM_TESTNET]: "0xEA8bC96E63Fc57ecec57d5a1486D5e88ad28CBa5",
};
export const TENDER_ESCROW_ADDRESSES: any = {
  [NetworkId.MAINNET]: "",
  [NetworkId.FANTOM]: "",
  [NetworkId.FANTOM_TESTNET]: "0xa4f5ab4d39763f53d2dd23BAF96722c32dF633ef",
};
