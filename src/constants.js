...
export const addresses = {
  4: {
    ...
    LP_ADDRESS: "0x366c22dbb3a69025bc2c6216305f047ed5db9192", // is this current? -- can delete from 1 and 4 after bond new bond calc implemented
    ...
    DAO: "0x245cc372C84B3645Bf0Ffe6538620B04a217988B", // only needed to calculate circulating supply (dao - total) without subgraph
    ...
    POOL_TOGETHER: {
      PRIZE_POOL_ADDRESS: "0xF89e906632b1B1C036A92B56d3409347735C5D4c", // contract to get current prize amount, deposit/withdraw on pool
      PRIZE_STRATEGY_ADDRESS: "0x54c18FB75f946424AF15221414B15a814Ca1EFD0", // contract to start/complete award
    },
  },
  1: {
    ...
    // BONGINGCALC_ADDRESS: "", <-- implement in place of lp_address/bongingcalc_address in bond.actions
