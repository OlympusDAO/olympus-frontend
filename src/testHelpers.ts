...
export const mockCurrentIndex = (data: string): UseQueryResult<string, Error> => {
  return {
    data: data,
    error: null,
    isError: false,
...
export const mockTotalDonated = (data: DecimalBigNumber): UseQueryResult<DecimalBigNumber, Error> => {
  return {
    data: data,
    error: null,
    isError: false,
