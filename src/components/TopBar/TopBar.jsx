...
const SOHM_ADDRESS = addresses[1].SOHM_ADDRESS;
const OHM_ADDRESS = addresses[1].OHM_ADDRESS;
const TOKEN_DECIMALS = 9;
const OHM_TOKEN_IMAGE =
...
const ohmMenu = (isShown = false, theme = "light", isBigScreen = false) => {
  const isEthereumAPIAvailable = window.ethereum;
  return isShown ? (
    <div className="ohm-card add-ohm-wallet" style={{ right: isBigScreen ? "13vw" : "200px" }}>
      <div className="ohm-menu-container">
        <div style={{ marginBottom: "5px" }}>
          <a
            style={{ fontFamily: "Square", color: theme === "light" ? "black" : "white" }}
            href={`https://app.sushi.com/swap?inputCurrency=${addresses[1].RESERVES.DAI}&outputCurrency=${OHM_ADDRESS}`}
            target="_blank"
            rel="noreferrer"
          >
            Buy on Sushiswap{" "}
...
=======
    <div className="dapp-topbar">
      {ohmMenu(showOhmMenu, theme, isBigScreen)}
      <Flex className="dapp-topbar-items">
        <>
          <button
            id="get-ohm"
