...
import { addresses } from "../../constants";
<<<<<<< HEAD
>>>>>>> Use addresses from constant and use FRAX for uniswap
=======
import { getOhmTokenImage, getSohmTokenImage } from "../../helpers";
import { useSelector } from "react-redux";
>>>>>>> Use networkID
...
=======
            href={`https://app.uniswap.org/#/swap?inputCurrency=${addresses[1].RESERVES.FRAX}&outputCurrency=${OHM_ADDRESS}`}
>>>>>>> Use addresses from constant and use FRAX for uniswap
=======
            href={`https://app.uniswap.org/#/swap?inputCurrency=${addresses[networkID].RESERVES.FRAX}&outputCurrency=${OHM_ADDRESS}`}
>>>>>>> Use networkID
