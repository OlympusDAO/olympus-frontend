...
function Sidebar({
  ...
  return (
    <div className={`${isExpanded ? "show" : ""} col-lg-2 col-2 d-md-block sidebar collapse`} id="sidebarContent">
          ...
          <div className="dapp-nav">
            <NavLink
              ...
              isActive={(match, location) => {
                return !!match && ["/dashboard"].includes(match.url);
              }}
            >
            ...
            <NavLink
              ...
              className="button button-dapp-menu align-items-center"
              isActive={(match, location) => {
                return !isBondPage(match, location);
              }}
            >
