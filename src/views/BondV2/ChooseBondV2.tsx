                      ...
                      <TableBody>
                        {bondsV2.map(bond => {
                          if (bond.displayName !== "unknown")
                            return (
                              <BondTableData networkId={networkId} key={bond.index} bond={bond} inverseBond={false} />
                            );
                        })}
                      </TableBody>
                    </Table>
              ...
              <Box mt={2} className="help-text">
                <em>
                  <Typography variant="body2">
                    Important: New bonds are auto-staked (accrue rebase rewards) and no longer vest linearly. Simply
                    claim as sOHM or gOHM at the end of the term.
                  </Typography>
                </em>
              </Box>
            </Paper>
