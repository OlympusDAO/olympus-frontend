...
const CausesDashboard = lazy(() => import("./CausesDashboard"));
const GrantsDashboard = lazy(() => import("./GrantsDashboard"));
const GrantInfo = lazy(() => import("./GrantInfo"));
const ProjectInfo = lazy(() => import("./ProjectInfo"));
const RedeemYield = lazy(() => import("./RedeemYield"));
const YieldRecipients = lazy(() => import("./YieldRecipients"));
