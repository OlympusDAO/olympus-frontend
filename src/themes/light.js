...
const lightTheme = {
  ...
  gray: "#7c7c7c",
  blueish_gray: "#4e5157",
  textHighlightColor: "#ff8100", // "#F4D092",
  ...
  // background: "linear-gradient(180deg, #fff8ef 1%, #ffdf84 80%, #ff995d 100%)",
  backgroundImage: `url("https://i.insider.com/5bb22117be2012524c8b456a?width=1200&format=jpeg")`,
  backgroundSize: "cover",
  paperBg: "rgba(255, 255, 255, 0.2)",
  modalBg: "#FAFAFAEF",
  popoverBg: "rgba(255, 255, 255, 0.95)",
  menuBg: handleBackdropFilter("rgba(255, 255, 255, 0.5)"),
  backdropBg: "rgba(200, 200, 200, 0.4)",
  largeTextColor: "#ffa400",
  activeLinkColor: "#222222",
  activeLinkSvgColor: "invert(64%) sepia(11%) saturate(934%) hue-rotate(157deg) brightness(90%) contrast(86%)",
  // primaryButtonBG: "#ffa400",
  primaryButtonBG: "#ff8100",
  primaryButtonHoverBG: "#ffa400",
  // these need fixing
        ...
        MuiCssBaseline: {
          "@global": {
            ...
            body: {
              ...
              backgroundImage: lightTheme.backgroundImage,
              backgroundSize: lightTheme.backgroundSize,
            },
          },
        },
        MuiPaper: {
