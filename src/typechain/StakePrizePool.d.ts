...
interface StakePrizePoolInterface extends ethers.utils.Interface {
  functions: {
...
export class StakePrizePool extends BaseContract {
  ...
  interface: StakePrizePoolInterface;
  ...
  filters: {
    ...
    "ErrorAwardingExternalERC721(bytes)"(
      error?: null
    ): TypedEventFilter<[string], { error: string }>;
