...
import type { AwardAbi, AwardAbiInterface } from "../AwardAbi";
...
export class AwardAbi__factory {
  static readonly abi = _abi;
  static createInterface(): AwardAbiInterface {
    return new utils.Interface(_abi) as AwardAbiInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): AwardAbi {
    return new Contract(address, _abi, signerOrProvider) as AwardAbi;
  }
}
