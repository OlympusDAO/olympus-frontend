...
import type {
  MultipleWinners,
  MultipleWinnersInterface,
} from "../MultipleWinners";
...
export class MultipleWinners__factory {
  static readonly abi = _abi;
  static createInterface(): MultipleWinnersInterface {
    return new utils.Interface(_abi) as MultipleWinnersInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): MultipleWinners {
    return new Contract(address, _abi, signerOrProvider) as MultipleWinners;
  }
}
