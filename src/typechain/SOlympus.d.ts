...
interface SOlympusInterface extends ethers.utils.Interface {
  functions: {
    ...
    "cannotReceive(address)": FunctionFragment;
    ...
    "toggleReceiver(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "cannotReceive",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "toggleReceiver",
    values: [string]
  ): string;
  encodeFunctionData(
...
export class SOlympus extends BaseContract {
  ...
  functions: {
    ...
    cannotReceive(arg0: string, overrides?: CallOverrides): Promise<[boolean]>;
  ...
  estimateGas: {
    ...
    cannotReceive(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
