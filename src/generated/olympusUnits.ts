...
export type POSTRewardsSubmitMerkleRoot200Status =
  (typeof POSTRewardsSubmitMerkleRoot200Status)[keyof typeof POSTRewardsSubmitMerkleRoot200Status];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const POSTRewardsSubmitMerkleRoot200Status = {
  SUBMITTED: "SUBMITTED",
  ALREADY_PENDING: "ALREADY_PENDING",
  ALREADY_COMPLETED: "ALREADY_COMPLETED",
} as const;

export type POSTRewardsSubmitMerkleRoot200 = {
  merkleRoot: string;
  message: string;
  safeUrl: string;
  startDate: string;
  status: POSTRewardsSubmitMerkleRoot200Status;
  success: boolean;
  txHash: string;
};

export type POSTRewardsSubmitMerkleRootBody = {
  chainId: LibChainId;
...
export type GETRewardsEpochRewards200 = {
  endDate: string;
  epochId: number;
  merkleRoot: string;
  rewards: RewardsUserEpochReward[];
...
export type GETRewardsEpochRewardsParams = {
  chainId: LibChainId;
};
...
export type RewardsUserEpochReward = {
  asset: string;
  chainId: LibChainId;
  epochYield: string;
  merkleLeaf: string;
...
/**
 * Calculates rewards distributed based on the latest RewardDistributor merkle root: - Derives the epoch date from lastRootSetTimestamp - Gets the epoch number from currentWeek - Uses the active season's rewards percentage - Calculates user daily units aggregated for that epoch - Uses total epoch yield for that epoch

@param chainId - Blockchain chain ID (e.g., 11155111 for Sepolia) @returns List of epoch rewards for each user who earned units in the computed epoch

@example GET /rewards/epochs?chainId=11155111

 * @summary Compute epoch rewards for all users

 */
export const gETRewardsEpochRewards = (params: GETRewardsEpochRewardsParams, signal?: AbortSignal) => {
  return customHttpClient<GETRewardsEpochRewards200>({ url: `/rewards/epochs`, method: "GET", params, signal });
};

export const getGETRewardsEpochRewardsQueryKey = (params: GETRewardsEpochRewardsParams) => {
  return [`/rewards/epochs`, ...(params ? [params] : [])] as const;
};

export const getGETRewardsEpochRewardsQueryOptions = <
  TData = Awaited<ReturnType<typeof gETRewardsEpochRewards>>,
  TError = APIErrorResponse,
>(
  params: GETRewardsEpochRewardsParams,
  options?: { query?: UseQueryOptions<Awaited<ReturnType<typeof gETRewardsEpochRewards>>, TError, TData> },
) => {
  const { query: queryOptions } = options ?? {};

  const queryKey = queryOptions?.queryKey ?? getGETRewardsEpochRewardsQueryKey(params);

  const queryFn: QueryFunction<Awaited<ReturnType<typeof gETRewardsEpochRewards>>> = ({ signal }) =>
    gETRewardsEpochRewards(params, signal);

  return { queryKey, queryFn, ...queryOptions } as UseQueryOptions<
    Awaited<ReturnType<typeof gETRewardsEpochRewards>>,
    TError,
    TData
  > & { queryKey: QueryKey };
};

export type GETRewardsEpochRewardsQueryResult = NonNullable<Awaited<ReturnType<typeof gETRewardsEpochRewards>>>;
export type GETRewardsEpochRewardsQueryError = APIErrorResponse;

/**
 * @summary Compute epoch rewards for all users

 */
export const useGETRewardsEpochRewards = <
  TData = Awaited<ReturnType<typeof gETRewardsEpochRewards>>,
  TError = APIErrorResponse,
>(
  params: GETRewardsEpochRewardsParams,
  ...
  const queryOptions = getGETRewardsEpochRewardsQueryOptions(params, options);
...
/**
 * Workflow: 1. Fetch merkle root and rewards data from database for the epoch 2. Check for already-pending transactions with the same merkle root 3. Create and propose Safe multisig transaction to setMerkleRoot() 4. Return Safe transaction hash and tracking URL

This endpoint enables merkle root submission via Safe multisig, ensuring governance over rewards distribution.

@param startDate - Epoch start date (YYYY-MM-DD format, from path) @param chainId - Blockchain chain ID (query param, e.g., 11155111 for Sepolia) @param safeAddress - Safe multisig address that will execute the transaction (query param) @param rewardDistributorAddress - RewardDistributor contract address (query param) @returns Safe transaction details and tracking URL

@example POST /rewards/submit-merkle-root/2024-01-01?chainId=11155111&safeAddress=0x...&rewardDistributorAddress=0x...

Response: { "success": true, "txHash": "0x...", "safeUrl": "[https://app.safe.global/transactions/tx?safe=0x...&id=multisig\_0x](https://app.safe.global/transactions/tx?safe=0x...&id=multisig_0x)...", "merkleRoot": "0x...", "startDate": "2024-01-01", "status": "SUBMITTED", "message": "Merkle root for epoch starting 2024-01-01 proposed to Safe multisig. 150 users included in distribution." }

 * @summary Submit merkle root for a specific epoch to RewardDistributor contract

 */
export const pOSTRewardsSubmitMerkleRoot = (
  startDate: string,
  pOSTRewardsSubmitMerkleRootBody: POSTRewardsSubmitMerkleRootBody,
) => {
  return customHttpClient<POSTRewardsSubmitMerkleRoot200>({
    url: `/rewards/submit-merkle-root/${startDate}`,
    method: "POST",
    headers: { "Content-Type": "application/json" },
    data: pOSTRewardsSubmitMerkleRootBody,
  });
};

export const getPOSTRewardsSubmitMerkleRootMutationOptions = <TError = APIErrorResponse, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof pOSTRewardsSubmitMerkleRoot>>,
    TError,
    { startDate: string; data: POSTRewardsSubmitMerkleRootBody },
    TContext
  >;
}): UseMutationOptions<
  Awaited<ReturnType<typeof pOSTRewardsSubmitMerkleRoot>>,
...
> => {
  ...
  const mutationFn: MutationFunction<
    ...
    { startDate: string; data: POSTRewardsSubmitMerkleRootBody }
  > = props => {
    const { startDate, data } = props ?? {};

    return pOSTRewardsSubmitMerkleRoot(startDate, data);
  };

  return { mutationFn, ...mutationOptions };
};

export type POSTRewardsSubmitMerkleRootMutationResult = NonNullable<
  Awaited<ReturnType<typeof pOSTRewardsSubmitMerkleRoot>>
>;
export type POSTRewardsSubmitMerkleRootMutationBody = POSTRewardsSubmitMerkleRootBody;
export type POSTRewardsSubmitMerkleRootMutationError = APIErrorResponse;

/**
 * @summary Submit merkle root for a specific epoch to RewardDistributor contract

 */
export const usePOSTRewardsSubmitMerkleRoot = <TError = APIErrorResponse, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof pOSTRewardsSubmitMerkleRoot>>,
    TError,
    { startDate: string; data: POSTRewardsSubmitMerkleRootBody },
  ...
  const mutationOptions = getPOSTRewardsSubmitMerkleRootMutationOptions(options);
