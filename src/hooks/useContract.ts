...
import { FuseProxy, IERC20, OlympusStakingv2, PairContract, SOhmv2, Tender, WsOHM } from "src/typechain";
...
export const useWrappedContract = createStaticContract<WsOHM>(WSOHM_ABI);
export const useTenderEscrowContract = createDynamicContract<Tender>(TENDER_ABI);
