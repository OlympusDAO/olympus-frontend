...
import { contractForReserve, addressForAsset, contractForBond, setAll, toNum } from "../helpers";
...
`;
    ...
    // Get ETH price
    const ethBondContract = contractForBond({ bond: BONDS.eth, networkID, provider }) as ethers.Contract;
    ...
    let ethAmount = toNum(await token.balanceOf(treasuryAddress));
